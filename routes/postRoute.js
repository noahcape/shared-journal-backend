...
router.delete("/:id", auth, async (req, res) => {
    console.log("delete")
    const post = await Post.findById(req.params.id).then(async () => await Post.findByIdAndDelete({ _id: req.params.id }).catch(err => { console.error(err) }).then(() => console.log("deleted")))
